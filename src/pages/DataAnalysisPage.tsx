...
export function DataAnalysisPage() {
  return <PageContainer><Section className="page-intro"><p className="eyebrow">Portfolio area</p><h1>Data analysis</h1><p>[DATA ANALYSIS DETAILS]</p></Section>
    <Section><SectionHeading title="Analysis work" description="Verified data-analysis examples and outputs will be added here." /><ProjectGrid projects={dataAnalysisProjects} emptyTitle="Data analysis examples will appear here" /></Section>
