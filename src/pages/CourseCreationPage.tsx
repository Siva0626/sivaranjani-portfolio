...
export function CourseCreationPage() {
  return <PageContainer><Section className="page-intro"><p className="eyebrow">Portfolio area</p><h1>Course creation</h1><p>[COURSE DETAILS]</p></Section>
    <Section><SectionHeading title="Course work" description="Verified course examples and outputs will be added here." /><ProjectGrid projects={courseCreationProjects} emptyTitle="Course examples will appear here" emptyDescription="Verified course examples and outputs will be added here."/></Section>
