...
export function ProjectsPage() {
  return <PageContainer><Section className="page-intro"><p className="eyebrow">Work & projects</p><h1>Projects</h1><p>[PROJECT DETAILS]</p></Section>
    <Section><SectionHeading title="Project collection" description="Project cards show supplied details only." /><ProjectGrid projects={projects} emptyTitle="Projects will appear here" /></Section>
